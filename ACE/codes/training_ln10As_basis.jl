...
function get_observable_tuple(cosmo_pars, result)
    return (cosmo_pars["z"], cosmo_pars["ln10As"], cosmo_pars["ns"], cosmo_pars["H0"], cosmo_pars["ombh2"],
...
n_output_features = length(npzread(joinpath(path_input, readdir(path_input)[1], "result_ln10As_basis.npy")))

# Function for adding observable to dataframe
observable_file = "/result_ln10As_basis.npy"
